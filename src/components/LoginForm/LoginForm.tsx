  ...
  return (
    ...
    >
      <label className="input input-bordered input-primary flex items-center gap-2">
        ...
        <input {...register('login')} type="text" className="grow" placeholder={t('global:loginForm1')} />
      </label>
      ...
      <button className="text-md btn btn-outline  btn-primary h-16 bg-[#1A202C]">{t('global:loginBtn')}</button>
      <button
