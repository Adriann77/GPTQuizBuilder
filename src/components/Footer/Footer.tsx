  ...
  return (
    <footer className="footer flex h-[5vh] items-center justify-around bg-[#1A202C] p-4 text-neutral-content">
      ...
      <div className="grid-flow-col gap-4 md:place-self-center md:justify-self-end ">
        <a aria-label="github" className="rounded-full bg-white" href="https://github.com/Adriann77">
        ...
        <a aria-label="linkedin" target="_blank" href="https://www.linkedin.com/in/adrian-klimas-87b169281/">
